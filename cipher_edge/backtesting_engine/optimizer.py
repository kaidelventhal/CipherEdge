...
from cipher_edge.backtesting_engine.monte_carlo_simulator import MonteCarloSimulator
from cipher_edge.config.settings import settings as app_settings, PROJECT_ROOT
from cipher_edge.app_logger import get_logger

from cipher_edge.strategy_framework.strategy_manager import STRATEGY_REGISTRY
from cipher_edge.backtesting_engine.engine import POSITION_SIZER_REGISTRY, STOP_MANAGER_REGISTRY
...
class StrategyOptimizer:
    ...
    def _optuna_objective(self, trial: optuna.Trial, trial_def: Dict, train_data: pd.DataFrame) -> float:
        ...
        params_to_optimize = self._generate_param_grid(trial_def['strategy_name'])[0]
